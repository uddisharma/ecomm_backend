...
router.route("/admin/category/list").post(
  // auth(PLATFORM.ADMIN),
  // checkRolePermission,
...
router.get("/admin/category/all/all", categoryController.getAllCategories);
router.get("/admin/category/all/all/:id", categoryController.getCategoryById);
router
...
router.post("/admin/category/addBulk", categoryController.bulkInsertCategory);
// .post(
//   auth(PLATFORM.ADMIN),
//   checkRolePermission,

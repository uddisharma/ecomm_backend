...
router
  ...
  .post(
    auth(PLATFORM.ADMIN),
    checkRolePermission,
    shippingController.findAllShipping
  );
router
  ...
  .post(
    auth(PLATFORM.ADMIN),
    checkRolePermission,
    shippingController.getShippingCount
  );
router
...
router
  ...
  .put(
    auth(PLATFORM.ADMIN),
    checkRolePermission,
    shippingController.partialUpdateShipping
  );
router
  ...
  .put(
    auth(PLATFORM.ADMIN),
    checkRolePermission,
    shippingController.softDeleteShipping
  );
router
  ...
  .put(
    auth(PLATFORM.ADMIN),
    checkRolePermission,
    shippingController.softDeleteManyShipping
  );
router
  ...
  .post(
    auth(PLATFORM.ADMIN),
    checkRolePermission,
    shippingController.bulkInsertShipping
  );
router
  ...
  .put(
    auth(PLATFORM.ADMIN),
    checkRolePermission,
    shippingController.bulkUpdateShipping
  );
router
...
router
  ...
  .post(
    auth(PLATFORM.ADMIN),
    checkRolePermission,
    shippingController.deleteManyShipping
  );
